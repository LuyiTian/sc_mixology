---
title: "cellmix 12 normalization and imputation"
...
log_file =paste("log_file/normimpute_cellmix",format(Sys.time(), "%a_%b_%d"),"txt",sep = ".")
...
```{r}
saveRDS(res1, file="/stornext/General/data/user_managed/grpu_mritchie_1/SCmixology/analysis_for_resubmit/rdata/cellmix_all_after_normalization.Rds")
saveRDS(res2, file="/stornext/General/data/user_managed/grpu_mritchie_1/SCmixology/analysis_for_resubmit/rdata/cellmix_all_after_imputation.Rds")
```
