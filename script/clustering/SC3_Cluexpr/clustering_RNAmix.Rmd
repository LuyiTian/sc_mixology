...
log_file =paste("/Users/tian.l/Dropbox/research/benchmark/resubmit_code/log_file/clustering_RNAmix",format(Sys.time(), "%a_%b_%d"),".txt",sep = ".")
...
```{r}
res2 = readRDS("/Users/tian.l/data/rdata/RNAmix_all_after_imputation.Rds")
```
...
```{r}
saveRDS(res_c, file="~/Dropbox/research/benchmark/resubmit_code/cluster/RNAmix_after_clustering_mac.Rds")
```
