...
write.csv(cellmix1,file="mixture_design/SortSeq_Mixture_Sample_metadata.csv",row.names = FALSE)
```
...
RNAmix_design1$group = paste(RNAmix_design1$H2228_prop,RNAmix_design1$H1975_prop,RNAmix_design1$HCC827_prop,sep = "_")
RNAmix_design1 = RNAmix_design1[,c("cell_name","wall_position","mix","H2228_prop","H1975_prop","HCC827_prop","mRNA_amount","group")]
write.csv(cellmix1,file="mixture_design/CelSeq2_Mixture_Sample_metadata.csv",row.names = FALSE)
```
